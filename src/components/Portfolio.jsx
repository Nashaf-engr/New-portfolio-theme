    ...
    >
      ...
      >
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center p-6 text-center select-none pointer-events-none z-20 mix-blend-difference">
          ...
          <h3 className="font-display font-bold text-3xl uppercase text-white/75">NASEEF SHARAF</h3>
        </div>
      ...
      <div className="absolute bottom-10 left-1/2 -translate-x-1/2 flex items-center gap-4 bg-zinc-900/60 border border-white/10 px-6 py-3.5 rounded-full backdrop-blur-md z-30 shadow-2xl">
        <span className="text-[10px] font-mono tracking-wider text-zinc-400 uppercase">Glow Aura</span>
